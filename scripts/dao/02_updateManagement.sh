...
variable=${difference}; jq --argjson variable "$variable" '.fields[0].int=$variable' ../data/dao/update-management.json > ../data/dao/update-management-new.json
mv ../data/dao/update-management-new.json ../data/dao/update-management.json

# update the direciton, 0 is increase
variable=${direction}; jq --argjson variable "$variable" '.fields[1].int=$variable' ../data/dao/update-management.json > ../data/dao/update-management-new.json
    mv ../data/dao/update-management-new.json ../data/dao/update-management.json
...
FEE=$(${cli} transaction build \
    ...
    --spending-reference-tx-in-redeemer-file ../data/dao/update-management.json \
